...
WebUI.click(findTestObject('Object Repository/Page_List book/a_Sign out'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Index/h1_Welcome to online CSE bookstore'), 'Welcome to online CSE bookstore')
